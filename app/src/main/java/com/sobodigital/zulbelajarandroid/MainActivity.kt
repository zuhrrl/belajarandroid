...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        destinations = mutableListOf(Destination(name = "Labuan Bajo", R.drawable.image1, "Labuan Bajo adalah sebuah kota kecil yang terletak di barat Pulau Flores, Indonesia. Terkenal sebagai gerbang menuju Taman Nasional Komodo dan Kepulauan Komodo yang merupakan situs Warisan Dunia UNESCO" + "\n\n" + "taman Nasional Komodo masuk ke dalam Warisan Dunia UNESCO karena memiliki keanekaragaman hayati yang luar biasa, terutama dengan populasi komodo, spesies endemik yang dilindungi." + "\n\n" +  "Labuan Bajo menawarkan pesona alam yang menakjubkan. Kota ini dikelilingi oleh bukit-bukit hijau yang menghadap ke laut biru yang indah, Bukit-bukit hijau di Labuan Bajo sering disebut sebagai \"Bukit Cinta\" atau \"Bukit Amelia\".\n"),
